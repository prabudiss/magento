...
class Nuvodev_Banners_Block_Adminhtml_Featured_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("featured_data") && Mage::registry("featured_data")->getId() ){
				    ...
				    return Mage::helper("banners")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("featured_data")->getId()));
